"""
Base Django settings shared across all environments for the Bookshelf platform.
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "core.exceptions.bookshelf_exception_handler",
...
DEFAULT_FROM_EMAIL = config(
    "DEFAULT_FROM_EMAIL", default="Bookshelf <no-reply@book-shelf.pk>"
)
...
JAZZCASH_RETURN_URL = config(
    "JAZZCASH_RETURN_URL",
    default="http://localhost:8000/api/v1/payments/jazzcash/callback/",
)
...
DEFAULT_SHIPPING_FEE = config("DEFAULT_SHIPPING_FEE", default="200.00")
FREE_SHIPPING_THRESHOLD = config("FREE_SHIPPING_THRESHOLD", default="3000.00")
