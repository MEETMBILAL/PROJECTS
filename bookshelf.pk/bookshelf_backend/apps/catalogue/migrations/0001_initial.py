    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "authors",
                    models.ManyToManyField(related_name="books", to="catalogue.author"),
                ),
                (
                    "category",
                    models.ForeignKey(
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="books",
                        to="catalogue.publisher",
                    ),
                ),
                (
                    "tags",
                    models.ManyToManyField(
                        blank=True, related_name="books", to="catalogue.tag"
                    ),
                ),
            ],
            options={
                "ordering": ["-created_at"],
                "indexes": [
                    models.Index(fields=["slug"], name="catalogue_b_slug_2a10e4_idx"),
                    models.Index(
                        fields=["is_active", "is_featured"],
                        name="catalogue_b_is_acti_531c2b_idx",
                    ),
                    models.Index(
                        fields=["is_active", "is_bestseller"],
                        name="catalogue_b_is_acti_332d23_idx",
                    ),
                    models.Index(
                        fields=["is_active", "is_new_arrival"],
                        name="catalogue_b_is_acti_5ed64a_idx",
                    ),
                ],
            },
        ),
